...
export const themeRoot = resolve(pkgRoot, 'style')
export const hookRoot = resolve(pkgRoot, 'hooks')
export const localeRoot = resolve(pkgRoot, 'locale')
export const directiveRoot = resolve(pkgRoot, 'directives')
export const epRoot = resolve(pkgRoot, 'omd-design-plus')
export const utilRoot = resolve(pkgRoot, 'utils')
export const buildRoot = resolve(projRoot, 'hammer', 'build')
...
/** `/dist/omd-design-plus` */
export const epOutput = resolve(buildOutput, 'omd-design-plus')
